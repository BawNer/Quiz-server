...
export class optimizeRelations1654851068728 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "interviewers" ADD CONSTRAINT "FK_3b2dd07769c5ffe3bf76043ee30" FOREIGN KEY ("quizId") REFERENCES "quiz"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
